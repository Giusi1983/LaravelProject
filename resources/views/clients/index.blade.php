...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">  <h4>Aggiungi Nuovo Cliente</h4>
    ...
    <script>
        ...
        // Funzione per gestire l'aggiunta del cliente
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            const newRow = `
                                <tr id="client-row-${newClient.id}">
                                    <td>${newClient.id}</td>
                                    <td>${newClient.first_name}</td>
                                    <td>${newClient.last_name}</td>
                                    <td>${newClient.email}</td>
                                    <td>${newClient.phone}</td>
                                    <td>
                                        <a href="/clients/${newClient.id}" class="btn btn-info btn-sm">Fatture</a>
                                        <button class="btn btn-danger btn-sm delete-client-btn" data-id="${newClient.id}">Elimina</button>
                                    </td>
                                </tr>
                            `;
                            $('#client-table-body').append(newRow);
